...
function fun() { 
if (i == 0) { 
window.location.href = "http://localhost:8080/travelnews/toFirstWeb.jsp"; 
...
<h2><a style="color:red">对不起！您已经被禁言！请联系管理员或浏览其他功能。</a></h2> 
<div id="error"> 
<!-- <img src="images/image5.jpg" mce_src="images/image5.jpg" alt="" />  -->
<!-- <p>登陆以后才能写游记！</p>  -->
<p><a style="color:green">将在 <span id="mes">5</span> 秒钟后返回首页！</a></p> 
</div> 
