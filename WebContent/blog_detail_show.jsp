                	...
                	<div class="main_content">
                    	<div class="block_breadcrumbs">
                            ...
                            <ul>
                                ...
                                <li><a href="blog_list.jsp">蝉游记</a></li>
                                <li>新鲜蝉游记</li>
                            </ul>
                        </div>
                       ...
                       <div class="f_pic"><a href="blogservlet?op=toBlog&id=${blog.id }" class="general_pic_hover scale"><img src="http://localhost:8080/travelnews/${blog.imgUrl}"></a></div>
                          ...
                          <p class="title"><a style="color:#227700;text-decoration:none;">${requestScope.blog.title }</a></p>
                           ...
                           <!--  <p class="subtitle">Many variations of passages of available, but the majority have suffered alteration in some form. Humour, or randomised words which don't look even slightly believable.</p> -->
                            ...
                            <div class="info">
                                <div class="date"><p>${requestScope.blog.publishTime }</p></div>
                                <div class="author"><p>作者: <a href="#">${requestScope.blog.author }</a></p></div>
                        ...
                        <div class="block_related_posts">
                        	<h3><a style="color:#F24024;text-decoration:none;">蝉游记TOP</a></h3>
                            
                            <div class="block_main_news">
                         <c:forEach items="${requestScope.blogList }" begin="1" end="4" var="blog">
                            	<article class="block_news_post">
                                    <div class="f_pic">
                                    <a href="blogservlet?op=toBlog&id=${blog.id }" class="w_hover">
									<img src="http://localhost:8080/travelnews/${blog.imgUrl}" height="90" width="100"></a></div>
