        ...
        <div id="content" class="right_sidebar">
        	<div class="inner">
             ...
             <div class="main_content">
                        ...
                        <h2><a style="color:#227700;text-decoration:none;">我的游记</a></h2>
                        ...
                        <!-- 	<a href="#" class="close">Close</a> -->
                        	<a href="blogservlet?op=delete&id=${blog.id }" class="close">删除</a>
                            <p><b>题目:</b><a href="blogservlet?op=toBlog&id=${blog.id }" target="_blank"> ${blog.dealTitle }</a></b></p>
                          <%--  <p><b>${blog.author }</b> </p> --%>
                         <p><b>  ${blog.publishTime }</b></p>
                        </div>
