    ...
    <div class="main_content">
      ...
      <div class="line_4" style="margin:0px 0px 0px;"></div>
                        ...
                        <div class="block_blog_2">
                         ...
                         <form name="myform" method="post" action="blogservlet?op=batchDelete">
                         <c:forEach items="${requestScope.blogList }"  var="blog">
                        	<article class="blog_post">
                            	<div class="f_pic"><a href="blogservlet?op=toBlog&id=${blog.id }" class="general_pic_hover scale"><img src="http://localhost:8080/travelnews/${blog.imgUrl}" ></a></div>
                                
                                <div class="info">
                                	<!-- <div class="category">
                                    	<p>category: <a href="#">BUSINESS</a></p>
                                    </div> 
                                ...
                                <div class="title">
                                	<div class="tail"></div>
                                	<h5><a href="blogservlet?op=toBlog&id=${blog.id }" target="_blank">${blog.dealTitle }</a></h5>
                                </div>
                                ...
                                <div class="author">
                                    ...
                                    <div class="text">
                                    	<p class="name"><a>${blog.author }</a></p>
                                        <p class="date">${blog.publishTime }</p>
                                    </div>
      ...
      <div class="line_2" style="margin:22px 0px 29px;"></div>
                    ...
                    <div class="sidebar">
                    <h3><b style="color:red;">最新结伴游</b></h3>
				
                  
				 <c:forEach items="${requestScope.messageDetailList1 }"  var="message" begin="0" end="5">
                      <div class="block_testimonial_type_1">
                            <div class="block_testimonial_type_3">
                                ...
                                <div class="author"><p><b style="color:gray;">${message.publishTime }</b><b style="color:green;">用户ID：${message.userId }</b>. <span class="position"><a href="messagedetailservlet?op=toMessageDetail&id=${message.id }" class="position" style="color:red;">私信</a></span></p></div>
                            </div>
                        </div>
                       </c:forEach> 
