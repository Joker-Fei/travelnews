...
<body>
            	...
            	<section class="bottom">
                 ...
                 <section class="section_main_menu">
                	<div class="inner">
                    	<nav class="main_menu">
                        	<ul>
								<li class="big_dropdowns"><a href="toFirstWeb.jsp">首页</a></li>
  ...
  <form action="blogservlet?op=writeblog" method="post" enctype="multipart/form-data" name="form1" onsubmit="return formCheck33();" >
 
	<table class="right-table" width="70%"  border="0px" cellpadding="0"  cellspacing="0">
		<tr>
			<td nowrap><a style="color:#227700;text-decoration:none;">标题</a></td>
			<td><input maxlength="25" style="width:320px;height:20px" type="text" name="title"/><b>请控制在25个字以内</b></td>
		</tr>
			<tr>
			<td nowrap><a style="color:#227700;text-decoration:none;">图片上传</a></td>
			    <td><input type="file" name="imgUrl"/></td> 
		</tr>
		<tr>
			<td nowrap><a style="color:#227700;text-decoration:none;">作者</a></td>
			<td><b style="color:black;">${sessionScope.loginUser.userName }</b>
			</td>
		</tr>
		 
		<tr nowrap>
			<td><a style="color:#227700;text-decoration:none;">时间</a></td>
			<td><input type="text" name="publishTime" onClick="WdatePicker()" class="Wdate"/></td>
		</tr>
		<tr nowrap>
			<td colspan="2">
				<a style="color:#F24024;text-decoration:none;">置顶：</a><input type="radio" name="topper" value="1"/>是
				<input type="radio" name="topper" value="0" checked="checked"/>否
				
				<a style="color:#F24024;text-decoration:none;">加粗：</a><input type="radio" name="bold" value="1"/>是
				<input type="radio" name="bold" value="0" checked="checked"/>否
				<a style="color:#F24024;text-decoration:none;">颜色：</a>
				<select name="color">
		...
		<tr>
			<td></td>
			<td>
				<textarea  class="xheditor" rows="15" cols="69" name="content"></textarea>
		...
		<tr>
			...
			<div class="block_buttons">
				 <input style="margin-left:10px; margin-top:20px" class="general_button standart type_3" type="submit" value="发表"/>
			</div>
			</td>
		</tr>
	</table>
                    ...
                    <div class="sidebar">
                        ...
                        <div class="block_popular_posts">
                        	...
                        	<h4><a style="color:#F24024;text-decoration:none;">游记管理</a></h4>
                            
                            <ul>
                           		 <li><a href="blogservlet?op=listAll">新鲜蝉游记</a></li>
								<li><a href="blogservlet?op=list">我的游记</a></li>
