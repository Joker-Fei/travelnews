...
<body>
<div class="position">　<a style="font-size:14px;text-decoration:none;color:#FFAA33;" >当前位置：旅游路线管理　&gt;&gt;　路线类型管理　</a>
<div class="div1">
<form action="roadtypeservlet?op=add" method="post" name="form1" onsubmit="return formCheck33();" >

	<tbody>

            <div class="search" align="center">
            <span>线路主题：<input style="color:#999999;width:300px;height:25px" type="text" type="text" name="typeName"/><b>请控制在6个字以内</b></span>
        
            <span><input type="submit" id="search-btn" value="添加"/></span> 
            <span><a href="roadtypeservlet?op=list">刷新列表</a></span>
            </div>
		</table>
	</tbody>
	...
	<table class="right-table" width="50%"  border="0px" cellpadding="0" align="center" cellspacing="0">
		...
		<c:forEach items="${requestScope.roadTypeList }"  var="roadType" varStatus="status">
		  	<tr style="background-color: ${status.index%2==0?'':'#4F4F4F' } ">
				...
				<td>${roadType.typeName }</td>
			<td><a href="roadtypeservlet?op=delete&id=${roadType.id }">删除</a></td>
			</tr>
		</c:forEach>
	</table>
	</tbody>
