...
<form name="myform" action="userdetailservlet?op=search" method="post">
	...
	<table class="right-table" width="100%"  border="0px" cellpadding="0" align="center" cellspacing="0">
		...
		<tr>
			<td>注册时间</td>
			<td>
				<input style="width:100px;height:25px" type="text" name="startTime" onClick="WdatePicker()" class="Wdate" value="${requestScope.userDetail.dealStartTime }"/>到
				<input style="width:100px;height:25px" type="text" name="endTime" onClick="WdatePicker()" class="Wdate"  value="${requestScope.userDetail.dealEndTime }"/>
