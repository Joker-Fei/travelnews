    ...
    <div class="reg login">
        ...
        <form action="userdetailservlet" method="post" name="form1" id="form1">
            ...
            <dl>
   			...
   			<dd><span class="title"><a style="font-size:17px;color:white;text-decoration:none;font-weight:bold;">用户名：</a></span><input class="reg_input" name="iptNickName" id="iptNickName" onblur="checkNickName(this.value)" type="text" /><span id="iptNickNameTip" class="onshow"></span></dd>               
              <dd><span class="title"><a style="font-size:17px;color:white;text-decoration:none;font-weight:bold;">密           码：</a></span><input class="reg_input" onblur="return checkpasswd(this);" id="t_UserPass" name="t_UserPass" type="password"/><span id="t_UserPassTip" class="onshow"></span></dd>
            </dl>
