...
<body>
                        	...
                        	<ul>
								...
								<li class="big_dropdown" data-content="technology"><a href="newsdetailservlet?op=toNewsShow">旅游资讯</a></li>
                                 ...
                                 <li><a href="messagedetailservlet?op=listAll">结伴游</a>
                                    ...
                                    <ul>
                                    	<li><a href="messagedetailservlet?op=listAll">结伴游留言板</a></li>
                                    	<li><a href="messagedetailservlet?op=writealone">发布结伴游消息</a></li> 
            	...
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <div class="block_testimonial_type_1">
                        	<div class="text">
                            	<div class="tail"></div>
                               <p>${requestScope.messageDetail.content }</p>
                               <p><a style="color:green;">${requestScope.messageDetail.tag }</a></p>
                                </div>
                            
                          <div class="author"><p><b style="color:green;">我</b>&nbsp&nbsp&nbsp${requestScope.messageDetail.publishTime }</p></div> <%-- ${requestScope.messageDetail.id } --%>
                        </div>
                      ...
                      <!--1111111111111111111111自己的私信显示区1111111111111111   111111111111 -->
                        <div class="block_comments_type_2">
                        	<h3><a style="color:#F24024;text-decoration:none;">私信我的</a></h3>
                           
										<c:if test="${requestScope.letterList!=null }">
											
												<c:forEach items="${requestScope.letterList}" var="letter">
												
																<div class="comment">
																<div class="userpic"><a ><img src="images/ava_default_1.jpg" alt="" /></a></div>
																<div class="comment_wrap">
																	 <div class="name"><p>用户ID：${letter.userId }</p> </div>
																	 <div class="content"><p>${letter.content }</p></div>
																	
																	 <div class="date"><p>私信时间：${letter.writeTime }</p></div>
																</div>
				 											   <div class="clearboth"></div>
   ...
   <form method="post" action="letterservlet?op=add" class="w_validation">
  	 ...
  	 <table bord="1">
			...
			<tr>
				...
				<input type="hidden" value="${requestScope.messageDetail.id }" name="messageId"/>
				</td>
			</tr>
			<tr>
				<td><input type="submit" class="general_button" value="提交" /> </td>
                    ...
                    <div class="sidebar">
                         ...
                         <div class="block_sidebar_menu">
                        	<h4><b style="color:#F24024;text-decoration:none;">结伴游管理</b></h4>
                       ...
                       <div class="block_contacts">
                            ...
                            <p class="email">E-mail: <a href="mailto:#" 

target="_blank">huanqiulvyou@163.com</a></p>
