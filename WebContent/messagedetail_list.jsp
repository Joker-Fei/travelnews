                    	...
                    	<nav class="main_menu">
                        	<ul>
								...
								<li class="big_dropdown" data-content="technology"><a href="newsdetailservlet?op=toNewsShow">旅游资讯</a></li>
							  	...
							  	<li class="big_dropdown"><a href="blogservlet?op=listAll">蝉游记</a>
        ...
        <div id="content" class="right_sidebar">
        	<div class="inner">
             ...
             <div class="main_content">
                        ...
                        <h2><a style="color:#227700;text-decoration:none;">我的结伴游消息</a></h2>
                        
                        <div class="line_4" style="margin:0px 0px 22px;"></div>
                       
                        <c:forEach items="${requestScope.messageDetailList }"  var="message" varStatus="status">
                        
                        <div class="general_info_box success">
                     
                        	<a href="messagedetailservlet?op=delete&id=${message.id }" class="close">删除</a>
                            <p><b>标题:</b><a href="messagedetailservlet?op=toMessageDetailOfMine&id=${message.id }" target="_blank"> ${message.tag }</a></b></p>
                          <%--  <p><b>${blog.author }</b> </p> --%>
                         <p><b>  ${message.publishTime }</b></p>
                        </div>
