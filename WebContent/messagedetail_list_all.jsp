    ...
    <div class="main_content">
      ...
      <div class="line_4" style="margin:0px 0px 0px;"></div>
                        ...
                        <div class="separator" style="height:30px;"></div>
                            ...
                            <h5><b style="color:green;">最近出发旅行结伴</b></h5>
                         
                         <c:forEach items="${requestScope.messageDetailList }"  var="message">
                        ...
                        <div class="block_testimonial_type_1">
                           ...
                           <p>${message.publishTime }&nbsp&nbsp&nbsp&nbsp&nbsp用户ID:${message.userId }
                            <c:if test="${message.userId==loginUser.id }">
                            
                             <b class="position" style="color:green;">我</b>
                             
                            </c:if>
                            
                            <c:if test="${message.userId!=loginUser.id }">
                            
                            <a href="messagedetailservlet?op=toMessageDetail&id=${message.id }" class="position" style="color:red;">私信</a>
      ...
      <div class="line_2" style="margin:22px 0px 29px;"></div>
                    ...
                    <div class="sidebar">
                     ...
                     <div class="block_popular_posts">
                            ...
                            <c:forEach items="${requestScope.blogList }"  var="blog" begin="0" end="5"> 
                        	<div class="article">
								<div class="pic">
									<a href="blogservlet?op=toBlog&id=${blog.id }" class="w_hover">
										<img src="http://localhost:8080/travelnews/${blog.imgUrl}"  width="80px" height="40px"  >
										<span></span>
									</a>
								</div>
								...
								<div class="text">
									...
									<div class="date"><p><b style="color:green;">${blog.author }</b>${blog.publishTime }</p></div>
