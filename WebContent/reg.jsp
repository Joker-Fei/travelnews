...
<div class="main2">
	<div style="width:500px;height:400px;border:0px solid red;position:relative;">
  		<img src="images/logo.png" style="width:110px;height:50px;position:absolute;left:180px;top:20px;"/>
 	 </div>
</div>
<div  class="main">
<!--登录开始-->
...
<!--注册开始-->
    <div class="reg" >
        <form action="userdetailservlet?op=register" method="post" name="myform" id="form1">
            <dl>
             
                 <div style="height:170px; overflow:hidden"></div>
                <dd><span class="title"><a style="font-size:17px;color:white;text-decoration:none;font-weight:bold;">用户名：</a></span><input class="reg_input" name="iptNickName" id="iptNickName"  type="text" />
							
								<div id="iptNickNameTip" class="shurukuang" style="border: 0"></div>
								<div id="msg" class="main4" style="border: 0"></div>
							</dd>

                <dd><span class="title"><a style="font-size:17px;color:white;text-decoration:none;font-weight:bold;">登录密码：</a></span><input class="reg_input"  id="t_UserPass" name="t_UserPass" type="password"/><span id="t_UserPassTip" class="onshow"></span></dd>
                <dd><span class="title"><a style="font-size:17px;color:white;text-decoration:none;font-weight:bold;">确认密码：</a></span><input  class="reg_input" type="password" id="t_RePass" name="t_RePass"/><span id="t_RePassTip" class="onshow"></span></dd>
                
                <dd><span class="title"><a style="font-size:17px;color:white;text-decoration:none;font-weight:bold;">联系方式：</a></span><input class="reg_input" name='iptCard' type='text' id='iptCard'  /><span id="iptCardTip" class="onshow"></span></dd>
