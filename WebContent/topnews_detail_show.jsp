                	...
                	<div class="main_content">
                    	<div class="block_breadcrumbs">
                            ...
                            <ul>
                                ...
                                <!-- <li><a href="main_news_inland.jsp">境内资讯</a></li> -->
                                <li>新闻详情</li>
                            </ul>
                        </div>
                        ...
                        <article class="block_single_news">
                        	<!-- 图片 -->
                        	 <div class="f_pic"><img src="http://localhost:8080/travelnews/${topNewsDetail.imgUrl}" width="600" height="250" alt="" /></div>
                        
                          <p class="title"><a>${requestScope.topNewsDetail.title }</a></p>
                           ...
                           <!--  <p class="subtitle">Many variations of passages of available, but the majority have suffered alteration in some form. Humour, or randomised words which don't look even slightly believable.</p> -->
                            ...
                            <div class="info">
                                <div class="date"><p>${requestScope.topNewsDetail.publishTime }</p></div>
                                <div class="author"><p>作者: <a href="#">${requestScope.topNewsDetail.author }</a></p></div>
                                    
                            	
                            </div>
                            
                            <div class="content">
                            	<p>${requestScope.topNewsDetail.content }</p>
                      ...
                      <div class="separator" style="height:31px;"></div>
                        ...
                        <div class="block_popular_posts">
                        	...
                        	<div class="article">
								<div class="pic">
									<a	 class="w_hover">
										<img src="http://localhost:8080/travelnews/${topNews.imgUrl}" height="50" width="50"/>
										<span></span>
									</a>
								</div>
